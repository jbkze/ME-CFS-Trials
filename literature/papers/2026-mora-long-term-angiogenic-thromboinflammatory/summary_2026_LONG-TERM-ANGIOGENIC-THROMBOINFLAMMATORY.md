...
authors: ["Mora Zetina AA", "Ortega Sanchez EF", "Zuñiga Ascencio BS", "Castorena Maldonado AR", "Ahumada Topete VH", "Torres Espíndola LM", "Aquino Gálvez A", "et al."]
year: 2026
venue: "Angiogenesis"
...
Adds long-term evidence for a persistent blood-vessel and clotting abnormality behind lingering post-COVID fatigue — the same 'microclot'/vascular idea that also motivates some ME/CFS treatment approaches.

## Notes

Published online Aug 7, 2026 (print vol. 29(4)). n=32 previously-hospitalized COVID-19 patients, 3.5-year follow-up; persistent symptoms (fatigue/dyspnea/concentration problems) in ~65%; elevated VEGF-D and angiopoietin-1, raised alpha-2-macroglobulin, prolonged prothrombin time. Not Wirth/Scheibenbogen-affiliated. Confirmed via publisher DOI record (Springer, Angiogenesis journal).
