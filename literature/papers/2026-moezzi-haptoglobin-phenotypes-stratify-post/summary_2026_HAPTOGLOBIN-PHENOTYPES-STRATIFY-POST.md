...
authors: ["Moezzi A", "Elremaly W", "Leveau C", "Franco A", "Nepotchatykh O", "Armstrong CW", "Moreau A"]
year: 2026
...
Suggests a simple, already-testable genetic marker that could help explain why some post-viral patients get hit harder by post-exertional 'brain fog' than others, extending the same team's earlier ME/CFS finding to long COVID and pointing toward ways to predict who needs the most protection from overexertion.

## Notes

IJMS 27(15):7000, published Aug 4, 2026. Université de Montréal / CHU Sainte-Justine / OMF ME/CFS Center group (Moreau lab); n=44 long-COVID vs 20 recovered controls; 90-minute exertion challenge with BrainCheck cognitive testing, cerebral oximetry, and metabolomics. Extends the group's earlier ME/CFS haptoglobin work to long COVID. Not Wirth/Scheibenbogen-affiliated. Confirmed independently via MDPI publisher page and DOI resolution.
